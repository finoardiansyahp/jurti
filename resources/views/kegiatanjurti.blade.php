...
<div class="callout large primary" STYLE="background-color: #ffa500">
    ...
    <div class="row medium-8 large-7 columns">
        <div class="blog-post">
            <h4> Bulutangkis JurTI  <small>3/6/2017</small></h4>
            <img class="thumbnail" src="{{ asset('img/bultang.jpg') }}">
            <p>Diadakannya kegiatan bulutangkis,agar dapat mengisi waktu luang dan bisa mengurangi hal negatif yang ada
                dikalangan remaja sekarang. Setiap kita mengeluarkan keringat maka kita sudah mengeluarkan kalor/lemak
                jahat yang ada ditubuh kita. Marilah Hidup sehat sobat.
            </p>
            <a href="#" class="button small">Baca Selengkapnya disini</a>
        </div>
        <div class="blog-post">
            <h4> Futsal JurTI <small>3/7/2017</small></h4>
            <img class="thumbnail" src="{{ asset('img/futsal.jpg') }}">
            <p>Diadakannya kegiatan bulutangkis,agar dapat mengisi waktu luang dan bisa mengurangi hal negatif yang ada
                dikalangan remaja sekarang. Setiap kita mengeluarkan keringat maka kita sudah mengeluarkan kalor/lemak
                jahat yang ada ditubuh kita. Marilah Hidup sehat sobat.</p>
            <a href="#" class="button small">Baca Selengkapnya disini</a>
        </div>
        <div class="blog-post">
            <h4> Volly JurTI <small>3/8/2017</small></h4>
            <img class="thumbnail" src="{{ asset('img/volley.jpg') }}">
            <p>Diadakannya kegiatan bulutangkis,agar dapat mengisi waktu luang dan bisa mengurangi hal negatif yang ada
                dikalangan remaja sekarang. Setiap kita mengeluarkan keringat maka kita sudah mengeluarkan kalor/lemak
                jahat yang ada ditubuh kita. Marilah Hidup sehat sobat.</p>
            <a href="#" class="button small">Baca Selengkapnya disini</a>
        ...
        <div class="blog-post">
            <h4> Seminar Nasional "BIG DATA" JurTI <small>3/6/2016</small></h4>
            <img class="thumbnail" src="{{ asset('img/bigdata.jpg') }}">
