...
<div class="callout large primary" STYLE="background-color: #ffa500">
    <div class="row column text-center" >
        ...
        <h3>Jurusan Teknik Informatika menyediakan berbagai fasilitas yang dapat dimanfaatkan oleh mahasiswa dalam menunjang jalannya perkulihan.</h3>
    </div>
</div>
{{--</div>--}}
{{--<div class="callout large">--}}
    {{--<div class="row column text-center">--}}
        ...
        {{--<a href="#foto" class="button large">Foto</a>--}}
