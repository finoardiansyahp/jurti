...
<div class="row">
    ...
    <div class="text-center medium-6 large-3 columns">
        ...
        <p>Program Studi yang menjadi pusat penelitian dan pengembangan keahlian Sistem Informasi yang unggul secara keilmuan dan keahlian teknis yang relevan dengan kebutuhan pasar kerja nasional dan global serta berkontribusi di bidang Sistem Informasi Indonesia</p>
    </div>
</div>
...
<div class="row">
    <div class="large-6 columns">
        ...
        <p>PMW (Program Mahasiswa Wirausaha) adalah suatu program yang digagas oleh Dikti untuk dikembangkan ke dalam kehidupan kampus guna merangsang jiwa enterpreneurship (kewirausahaan) dalam diri mahasiwa. Program ini dilaksanakan setiap tahun pada hampir seluruh Universitas negeri dan Swasta di Indonesia.</p>
    </div>
    <div class="large-6 columns">
        <h4>X-PROJECT</h4>
        <img class="thumbnail" src="{{ asset('img/3.jpg') }}">
        <p>X-PROJECT 2015 merupakan acara perdana  yang diadakan oleh jurusan Teknik Informatika UNESA. Tentu karena jurusan Teknik Informatika adalah jurusan yang baru berdiri tahun ini yang terdiri atas 4 program studi.  Acara ini berlangsung pada Selasa, 22 desember 2015 tepatnya di Gedung B1 Teknik Informatika Unesa Ketintang.</p>
    </div>
</div>
