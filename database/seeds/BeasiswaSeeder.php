...
class BeasiswaSeeder extends Seeder
{
    ...
    public function run()
    {
        Beasiswa::create([
            ...
            Informasi beasiswa Bank Indonesia dan Tujuannya
